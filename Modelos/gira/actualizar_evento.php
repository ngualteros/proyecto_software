...
//incluye la clase noticia y CrudNoticia
  ...
  $ciudad = new Ciudad();
	...
	$evento=new Evento();
  $evento = $crud->obtenerEvento($_GET['cod_evento']);
  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
		...
		<h1><a>Modificar Evento</a></h1>
		<form action='acciones_giras.php' method='post'>
			<div class="form_description">
	<h2>Modificar Evento</h2>
	<p></p>
</div>

<input type="hidden" name="cod_gira" value='<?php echo $evento->getCodigoGira() ?>'>
<input type="hidden" name="cod_evento" value='<?php echo $evento->getCodigoEvento() ?>'>
<li id="li_1" >
<label class="description" for="nom_evento">Nombre del Evento</label>
<div>
<input type='text' required class="element text medium form-control" name='nom_evento' value='<?php echo $evento->getNombre()?>'>
</div>
</li>
<li id="li_3" >
<label class="description" for="descripcion_evento">Descripción Evento</label>
<div>
<input type='text' required class="element text medium form-control" name='descripcion_evento' value='<?php echo $evento->getDescripcion()?>' ></input>
</div>
</li>
...
<li id="li_2">
    ...
    <select name="cod_ciudad">
      <option selected value="<?php echo $evento->getCodigoCiudad() ?>"> Elige una opción / conservar </option>
          <?php
...
<div>
<input type='text' required class="element text medium form-control" name='valor_evento' value='<?php echo $evento->getValor()?>' ></input>
</div>
</li>


<center>
<input type='hidden' name='actualizarEvento' value='actualizarEvento'>
